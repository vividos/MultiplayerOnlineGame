...
{
    unsigned char minval = std::min(GetRValue(rgb), std::min(GetGValue(rgb), GetBValue(rgb)));
    unsigned char maxval = std::max(GetRValue(rgb), std::max(GetGValue(rgb), GetBValue(rgb)));
