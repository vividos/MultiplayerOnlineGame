...
for %%P in (Win32 x64) do for %%C in (Debug Release) do copy libogg\win32\VS2012\%%P\%%C\vc110.pdb         oggvorbis\lib\%%C\%%P\libogg_static.pdb
...
for %%F in (vorbis vorbisfile) do for %%P in (Win32 x64) do for %%C in (Debug Release) do copy libvorbis\win32\VS2012\lib%%F\%%P\%%C\vc110.pdb  oggvorbis\lib\%%C\%%P\lib%%F_static.pdb
